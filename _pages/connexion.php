<body class=" login" style="background-image: url(../images/fond.jpg) !important;background-repeat:no-repeat; background-size: cover; -webkit-filter: blur(8px); !important;" >
        <!-- BEGIN LOGO -->
        <div class="logo">
