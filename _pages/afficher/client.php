                                ...
                                <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_3" cellspacing="0" width="100%">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="<?php echo URLHOST.$_COOKIE['company'].'/client/'.$customerId.'/contact/modifier/'.$contact->getIdContact(); ?>"><i class="fas fa-edit" alt="Editer"></i></a></td>
                                            <td><a href="<?php echo URLHOST.$_COOKIE['company'].'/client/'.$customerId.'/contact/supprimer/'.$contact->getIdContact(); ?>"><i class="fas fa-trash-alt" alt="Supprimer"></i></a></td>
                                        </tr>
                                    <?php
                                        }
                                    ?>
