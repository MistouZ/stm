                ...
                <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_3" cellspacing="0" width="100%">
                    ...
                    foreach ($suppliermanager as $supplier) {
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo URLHOST.'fournisseur/afficher/'.$supplier->getIdSupplier(); ?>"><i class="fas fa-eye" alt="Détail"></i></a></td>
                            <td><a href="<?php echo URLHOST.'fournisseur/modifier/'.$supplier->getIdSupplier(); ?>"><i class="fas fa-edit" alt="Editer"></i></a></td>
                        </tr>
                        <?php
                    }
                    ?>
