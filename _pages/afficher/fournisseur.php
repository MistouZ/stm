        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php }elseif($retour == "errormodif") { ?>
                    <div class="alert alert-danger">
                        <button class="close" data-close="alert"></button> Une erreur est survenue, le fournisseur n'a donc pas pu être modifié !</div>
                <?php }elseif($retour == "successmodif"){ ?>
                    <div class="alert alert-success">
                        <button class="close" data-close="alert"></button> Le fournisseur a bien été modifié !</div>
                <?php } ?>
                        ...
                        <div id="collapse_2_1" class="panel-collapse in">
                            <div class="panel-body">
                                <div class="row static-info">
                                    ...
                                    <div class="col-md-7 value"> <?php echo $supplier->getName(); ?> </div>
                                </div>
                                <div class="row static-info">
                                    <div class="col-md-5 name"> Adresse physique: </div>
                                    <div class="col-md-7 value"> <?php echo $supplier->getPhysicalAddress(); ?> </div>
                                </div>
                                <div class="row static-info">
                                    <div class="col-md-5 name"> Adresse de facturation: </div>
                                    <div class="col-md-7 value"> <?php echo $supplier->getInvoiceAddress(); ?> </div>
                                </div>
                                <div class="row static-info">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body form">
                        <form action="<?php echo URLHOST."_pages/_post/modifier_fournisseur.php"; ?>" method="post" id="client" class="form-horizontal form-row-seperated">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4">Nom du fournisseur
                                    <span class="required"> * </span>
                                </label>
                                <div class="col-md-8">
                                    <div class="input-icon right">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <span class="help-block"> Cocher la ou les société(s) affiliée(s) au fournisseur </span>
