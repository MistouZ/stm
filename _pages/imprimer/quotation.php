    ...
    <div class="page-template">
        <?php if($printType=='header'){ ?>
            ...
            <div class="footer">
                ...
                <img src="<?php echo URLHOST; ?>images/societe/footer/<?php echo $companyNameData; ?>.jpg" alt="<?php echo $companyNameData; ?>" class="logo-default" style="display: block;  margin-left: auto; margin-right: auto; width: 100%" />  
            </div>
        <?php }else{ ?>
            <div class="header" >
