...
<script type="x/kendo-template" id="page-template">
    <div class="page-template">
        <?php if($printType=='header'){ ?>
            <div class="header" >
                <img src="<?php echo URLHOST; ?>images/societe/header/<?php echo $companyNameData; ?>.jpg" alt="<?php echo $companyNameData; ?>" class="logo-default" style="display: block;  margin-left: auto; margin-right: auto; width: 100%; bottom : 30px" />
            </div>
            <div class="footer">
